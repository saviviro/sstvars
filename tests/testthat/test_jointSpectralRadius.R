...
test_that("bound_JSR works correctly", {
  ...
  expect_equal(bound_JSR(mod112relg, epsilon=0.01, method="Gripenberg", print_progress=FALSE), c(0.8919073, 0.9022341), tol=1e-4)
  expect_equal(bound_JSR(mod122relg, epsilon=0.01, method="Gripenberg", print_progress=FALSE), c(0.8288584, 0.8390200), tol=1e-4)
  ...
  expect_equal(bound_JSR(mod123relg, epsilon=0.3, method="Gripenberg", print_progress=FALSE), c(0.9609557, 1.3269630), tol=1e-4)
