...
#' @param x object of class \code{'cfacthist'} generated by the function \code{cfact_hist}.
#' @param digits how many significant digits to print?
#' @param ... argumenta passed to the function \code{window} to select the time periods to print.
#' @param which_indices a numeric vector specifying the time period indices to print. Note that
#'  the first \eqn{p} values are initial values, so the time period \eqn{t} in the index \eqn{t+p}.
#'  The default is that all the time periods are printed.
#' @return Returns the input object \code{x} invisibly.
#' @export
