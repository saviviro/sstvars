...
#' @title Simulates historical counterfactual for structural STVAR models.
#'
...
#' @param nsteps how many steps ahead should be predicted, i.e., the forecast forecast horizon?
#' @param cfact_type a character string indicating the type of counterfactual to be computed: should the path of the policy
...
#'     \item{input}{A list containing the arguments used to calculate the counterfactual.}
#'  }
#' @seealso \code{\link{GIRF}}, \code{\link{GFEVD}}, \code{\link{linear_IRF}}, \code{\link{hist_decomp}}, \code{\link{cfact_hist}},  \code{\link{fitSSTVAR}}
...
cfact_fore <- function(stvar, nsteps, nsim=1000, pi=c(0.95, 0.80), pred_type=c("mean", "median"), exo_weights=NULL,
