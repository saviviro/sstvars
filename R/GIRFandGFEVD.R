...
#' @seealso \code{\link{GFEVD}}, \code{\link{linear_IRF}}, \code{\link{hist_decomp}}, \code{\link{cfact_hist}}, \code{\link{fitSSTVAR}}
#' @references
#'  \itemize{
...
#' @seealso \code{\link{GIRF}}, \code{\link{linear_IRF}}, \code{\link{hist_decomp}}, \code{\link{cfact_hist}}, \code{\link{fitSSTVAR}}
#' @references
#'  \itemize{
